 ...
 <?php
	...
	$resultado = $usuariodao->consultarUm($_POST["email"],$link);
								...
								<!-- Highlight -->
									<section class="box highlight">
										<form action="../Controller/alterarUsuario.php" method="POST">
											Primeiro Nome: <input type="text" name="pNome" value="<?php echo $pNome;?>" maxlength="20" required="true"> <br/>
											Segundo Nome: <input type="text" name="uNome" value="<?php echo $uNome;?>" maxlength="20" required="true"> <br/>
											Email: <input type="text" name="email" value="<?php echo $email;?>" maxlength="45" readonly> <br/>
											Nova Senha: <input type="password" name="senha" maxlength="100" required="true"> <br/>
